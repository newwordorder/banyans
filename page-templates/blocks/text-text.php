...
?>
  ...
  <div class="container space-below--<?php echo $spaceBelow ?>">
    <div class="row  <?php if( $flipLayout == 'yes' ): echo ''; endif; ?>">
        ...
        <div class="<?php if( $layout == '1/3' ): echo 'col-md-4'; endif; ?> <?php if( $layout == '1/2' ): echo 'col-md-6'; endif; ?> <?php if( $layout == '2/3' ): echo 'col-md-8'; endif; ?> flippable__text d-flex align-items-center">
            <?php echo $text2 ?>
        </div>
    </div>
  </div>
