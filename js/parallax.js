  ...
  function mr_parallax() {
    ...
    jQuery(document).ready(function() {
      ...
      (this.documentReady = function(a) {
        return (
          (m = c()),
          jQuery('body').hasClass('parallax-2d') &&
            ((k = 'translate(0,'), (l = 'px)')),
          h && (q.profileParallaxElements(), q.setupParallax()),
          e(a) ? void a() : void 0
        );
      }),
      ...
      (this.profileParallaxElements = function() {
        ...
        (g = []), (m = c()), (n = b());
        var d =
          '.bg-effect--parallax > .background-image-holder, .bg-effect--parallax ul.slides > li > .background-image-holder, .bg-effect--parallax ul.slides .owl-item > li > .background-image-holder';
        f() &&
          (d =
            '.viu .bg-effect--parallax > .background-image-holder, .viu .bg-effect--parallax ul.slides > li > .background-image-holder, .bg-effect--parallax ul.slides .owl-item > li > .background-image-holder'),
          (a = jQuery(d)),
          /Android|iPad|iPhone|iPod/i.test(
            navigator.userAgent || navigator.vendor || window.opera,
          ) &&
            (a = a.not(
              '.bg-effect--parallax-disable-mobile .background-image-holder, body.bg-effect--parallax-disable-mobile *',
            )),
          jQuery(a).each(function(a) {
            var b = jQuery(this).closest('.bg-effect--parallax'),
            ...
            g.push({
              ...
              /iPad|iPhone|iPod/i.test(
                ...
                (0 === window.orientation && d > e
                  ? (jQuery(this).css('top', '-' + d / 2 + 'px'),
                    jQuery(this).css({
                      'min-height': b.is(':nth-of-type(1)') ? 1.5 * d : 1.2 * d,
                    }))
                  : (jQuery(this).css('top', '-' + e / 2 + 'px'),
                    jQuery(this).css({
              ...
              f()
                ? f() &&
                  (b.is(':nth-of-type(1)')
                    ? q.mr_setTranslate3DTransform(
                        jQuery(this).get(0),
                        0 === q.mr_getScrollPosition()
                          ? 0
                          : q.mr_getScrollPosition() / 2,
                      )
                    : q.mr_setTranslate3DTransform(
                        jQuery(this).get(0),
                        (q.mr_getScrollPosition() - c - n) / 2,
                      ))
                : b.is(':nth-of-type(1)')
                ? q.mr_setTranslate3DTransform(
                    jQuery(this).get(0),
      ...
      (this.mr_parallaxBackground = function() {
        for (
          var a,
            b = g.length,
            c =
              'undefined' == typeof mr || f()
                ? q.mr_getScrollPosition()
                : mr.scroll.y;
          b--;
          ...
          (a = g[b]),
            f()
              ? c + m - n > a.elemTop &&
                c - n < a.elemBottom &&
                (a.isFirstSection
                  ? (a.imageHolder.style[j] = k + c / 2 + l)
                  : (a.imageHolder.style[j] = k + (c - a.elemTop - n) / 2 + l))
              : c + m >= a.elemTop &&
                c <= a.elemBottom &&
                (a.isFirstSection
                  ? (a.imageHolder.style[j] = k + c / 2 + l)
                  : (a.imageHolder.style[j] = k + (c + m - a.elemTop) / 2 + l));
        p = !1;
      }),
