	...
	<div class="header__inner" >
		<div class="d-flex align-items-center w-100">
			...
			<a href="<?php echo get_home_url(); ?>" id="site-logo" class="header__logo">
				...
				<img class="logo logo--light" data-src="<?php bloginfo('template_directory'); ?>/img/logo--light.svg" src="<?php bloginfo('template_directory'); ?>/img/logo--light.svg" alt="The Banyans">
				<img class="logo logo--dark" data-src="<?php bloginfo('template_directory'); ?>/img/logo--dark.svg" src="<?php bloginfo('template_directory'); ?>/img/logo--dark.svg" alt="The Banyans">
			</a>
			</div>
